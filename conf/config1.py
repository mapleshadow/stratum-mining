...
CENTRAL_WALLET = 'am4dGaXsMdhyNztUrahuXsmt8Am2RHZwK9'    # local coin address where money goes

COINDAEMON_TRUSTED_HOST = '120.0.0.1'
COINDAEMON_TRUSTED_PORT = 9892
COINDAEMON_TRUSTED_USER = 'usr'
COINDAEMON_TRUSTED_PASSWORD = 'pwd'

COINDAEMON_ALGO = 'xcoin'    # The available options are:  scrypt, sha256d, scrypt-jane, skeinhash, xcoin, and quark
...
STRATUM_MINING_PROCESS_NAME= 'twistd-stratum-mining-dark'
...
PASSWORD_SALT = '578913567897342288978989'
...
PREVHASH_REFRESH_INTERVAL = 1       # How often to check for new Blocks
...
POOL_TARGET = 0.001                        # Pool-wide difficulty target
...
VDIFF_MAX_TARGET = 0.08                # Maximum Target difficulty 
...
MEMCACHE_PREFIX = "stratum_dark" # Prefix for keys
